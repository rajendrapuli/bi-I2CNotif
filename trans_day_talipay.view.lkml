view: trans_day_talipay {
  derived_table: {
    sql: select transaction_date as talipay_tr_date, count(id) as talipay_posted_records from analytics_prod_talipay.i2c_posted where transaction_date = date_add(curdate(), INTERVAL -1 DAY)
      ;;
  }
